...
const (
	GreeterService_SayHello_FullMethodName = "/go_template.helloservice.v1.name.GreeterService/SayHello"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "go_template.helloservice.v1.name.GreeterService",
	...
	Metadata: "helloservice/v1/name/create.proto",
}
